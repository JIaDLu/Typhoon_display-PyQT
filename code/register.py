...
class Example(object):
    def setui(self,MainWindow):
        ...
        MainWindow.setObjectName("TropicalCyclone")
        MainWindow.setWindowTitle(_translate("TropicalCyclone", "台风路径查询助手"))
        ...
        self.label.setStyleSheet("#label{\n"
                                 "    color:rgb(170, 85, 0);background:rgb(225, 170, 215);border:2px solid #F3F3F5;border-radius:45px;\n"
